...
//   );
// }
// app/page.tsx (Version de test ultra-simple)
export default function HomePage() {
  return (
    <div>
      <h1>Bonjour Vercel !</h1>
      <p>Ceci est un test de déploiement simple.</p>
      <p>Si vous voyez ceci, le routage de base fonctionne sur Vercel.</p>
    </div>
  );
}
